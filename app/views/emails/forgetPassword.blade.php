...
<h5 style="font-weight: bold; -webkit-font-smoothing: antialiased; font-size: 14px; margin: 20px 0 10px; padding: 0; border: 0;">
	If you'd like your password to remain unchanged, please ignore this email.</h5>
<p style="margin: 10px 0 15px; padding: 0; border: 0;"><a href="{{URL::to('/')}}/#!/forget/{{$randomcode}}" style="color: #4183C4; text-decoration: none; margin: 0; padding: 0; border: 0;">Click here to reset your password »</a></p>
