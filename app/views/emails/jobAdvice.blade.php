...
<h4 style="font-weight: bold; -webkit-font-smoothing: antialiased; font-size: 16px; margin: 20px 0 10px; padding: 0; border: 0;">{{$job_title}}</h4>
<h5 style="font-weight: bold; -webkit-font-smoothing: antialiased; font-size: 14px; margin: 20px 0 10px; padding: 0; border: 0;">publish by :{{$hirer_orgname}}</h5>
<p style="margin: 10px 0 15px; padding: 0; border: 0;">{{$job_description}}</p>
<p style="margin: 15px 0; padding: 0; border: 0;">Contact Way</p>
<p style="margin: 15px 0; padding: 0; border: 0;">Email:<a href="mailto:{{$member_email}}" style="color: #4183C4; text-decoration: none; margin: 0; padding: 0; border: 0;">{{$member_email}}</a>
<br>
@if ($hirer_orgaddress)
	Address:{{$hirer_orgaddress}}<br>
@endif
@if ($hirer_orgsite)
	URL:<a href="{{$hirer_orgsite}}">{{$hirer_orgsite}}</a><br>
@endif
</p>
<p style="margin: 15px 0; padding: 0; border: 0;"><a href="{{URL::to('/')}}/#/job/detail/{{$jobId}}" style="color: #4183C4; text-decoration: none; margin: 0; padding: 0; border: 0;">Go to coozilla and check it out »</a></p>
