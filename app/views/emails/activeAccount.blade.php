...
<h5 style="font-weight: bold; -webkit-font-smoothing: antialiased; font-size: 14px; margin: 20px 0 10px; padding: 0; border: 0;">Welcome to coolzilla</h5>
<h5 style="font-weight: bold; -webkit-font-smoothing: antialiased; font-size: 14px; margin: 20px 0 10px; padding: 0; border: 0;">This is an activation email,Please do not reply.</h5>
<p style="margin: 10px 0 15px; padding: 0; border: 0;"><a href="{{URL::to('/')}}/LoginController/LoginService/activeAccount/{{$id}}" style="color: #4183C4; text-decoration: none; margin: 0; padding: 0; border: 0;">Click here to activate your account . Do it Now! »</a></p>
