...
```php
$now = Carbon::now();
echo $now;                               // 2014-02-26 01:47:59
$today = Carbon::today();
echo $today;                             // 2014-02-26 00:00:00
$tomorrow = Carbon::tomorrow('Europe/London');
echo $tomorrow;                          // 2014-02-27 00:00:00
$yesterday = Carbon::yesterday();
echo $yesterday;                         // 2014-02-25 00:00:00
```
...
echo Carbon::now();                                    // 2014-02-26 01:47:59
```
...
setlocale(LC_TIME, '');                           
echo $dt->formatLocalized('%A %d %B %Y');          // 星期四 25 十二月 1975
```
